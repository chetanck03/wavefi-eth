/**
 * PointsManager contract ABI
 * You'll need to paste the complete ABI here
 */
const POINTS_MANAGER_ABI = [
	{
		"inputs": [],
	...
	},
	{
		...
		"name": "transferPointsFromContract",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
...
export default POINTS_MANAGER_ABI;